    ...
    >
      ...
      <div className="px-8 py-4">
        ...
        >
          ...
          <h3 className="mt-2 text-center font-large font-bold">Smart <br />Demand <br /> Planning</h3>
        </motion.div>
      </div>
      <div className="px-8 py-4">
        <motion.div
        ...
        >
          ...
          <h3 className="mt-2 text-center font-large font-bold">Flexible <br /> Order <br />Routing</h3>
        </motion.div>
      </div>
      <div className="px-8 py-4">
        <motion.div
        ...
        >
          ...
          <h3 className="mt-2 text-center font-large font-bold">Live <br />Inventory <br /> Sync</h3>
        </motion.div>
      </div>
      <div className="px-8 py-4">
        <motion.div
        ...
        >
          ...
          <h3 className="mt-2 text-center font-large font-bold">Reliable <br />Fullfillment <br /> (99.9% SLA)</h3>
        </motion.div>
      </div>
      <div className="px-8 py-4">
        <motion.div
        ...
        >
          ...
          <h3 className="mt-2 text-center font-large font-bold">Data-backed <br />Operations</h3>
        </motion.div>
      </div>
    </div>
    </div>
